...
public class Scanner {
	...
	static {
		...
		start.set(39, 3); 
		start.set(34, 6); 
		for (int i = 42; i <= 43; ++i) start.set(i, 8);
		for (int i = 45; i <= 45; ++i) start.set(i, 8);
		for (int i = 47; i <= 47; ++i) start.set(i, 8);
		start.set(59, 9); 
		start.set(61, 10); 
		start.set(33, 11); 
		start.set(60, 13); 
		...
		literals.put("variables", new Integer(8));
		literals.put("main", new Integer(11));
		literals.put("int", new Integer(12));
		literals.put("boolean", new Integer(13));
		literals.put("char", new Integer(14));
		literals.put("string", new Integer(15));
		literals.put("read", new Integer(16));
		literals.put("true", new Integer(20));
		literals.put("false", new Integer(21));
		literals.put("print", new Integer(22));
		literals.put("if", new Integer(23));
		literals.put("else", new Integer(24));
		literals.put("while", new Integer(25));
	...
	Token NextToken() {
		...
		loop: for (;;) {
			switch (state) {
				...
				case 3:
					if (ch >= ' ' && ch <= '!' || ch == '%' || ch >= '/' && ch <= ':' || ch == '?' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'z') {AddCh(); state = 4; break;}
					else {state = 0; break;}
				case 4:
					if (ch == 39) {AddCh(); state = 5; break;}
					else {state = 0; break;}
				case 5:
					{t.kind = 3; break loop;}
				case 6:
					if (ch >= 9 && ch <= 10 || ch == 13 || ch >= ' ' && ch <= '!' || ch == '%' || ch >= '/' && ch <= ':' || ch == '?' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'z') {AddCh(); state = 6; break;}
